...
for (var i = 0; i < cargaObj.length; i++) {
	...
	$(cargaObj[i]).load(function () {
		...
		$("#rellenoCarga").css({
			"width": porcionPorcentaje * numCarga + "%"
		})
...
$("section#bloque5 button").click(function () {

	$("section#bloque5 form").slideToggle("fast");
